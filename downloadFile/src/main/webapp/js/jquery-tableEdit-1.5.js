...
(function($){
    		...
    		while(trCount > 0){
    			...
    			while(tdCount > 0){
    			    ...
    			    var yAxis = parseInt(currentTr$.children("td").first().data("yAxis"));
    					column$.find("div").css({"width":"100%","height":"100%","margin":"0","padding":"0","text-align":"center"}).text(yAxis + "." + xAxis);
    ...
    $(settings.addLine).click(function(event){
    	...
    	for(var i = 0; i < colNum; i++){
    		...
    		appendtd$.find("div").css({"width":"100%","height":"100%","margin":"0","padding":"0","text-align":"center"}); 
      ...
      $.each(insertBodyTds$,function(){
    	  ...
    	  if(getRowspan($(this)) > 1){
    	  	...
    	  	while(rowCount >= 1){
    	  	  ...
    	  	  newTd$.find("div").css({"width":"100%","height":"100%","margin":"0","padding":"0","text-align":"center"});
    ...
    function createTable(){
    	...
    	for(i = 0; i < rowNum; i++){
    		...
    		for (j = 0; j < colNum; j++){
    			...
    			appendtd$.find("div").css({"width":"100%","height":"100%","margin":"0","padding":"0","text-align":"center"}).text(i + "." + j);
    ...
    function cellDblClick(){
			var td = $(this), tdText = td.find(">div").text(),width=td.css("width"),height=td.css("height");
			td.find(">div").text("").append("<input type='text' style='overflow:hidden;margin:0;padding:0;height:100%;width:100%;text-align:center;'/>");
