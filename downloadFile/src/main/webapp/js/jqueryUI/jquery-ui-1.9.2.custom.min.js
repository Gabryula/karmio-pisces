...
(function(e, t) {
    ...
    e.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            o = (this.uiDialogTitlebar = e("<div>")).addClass("ui-dialog-titlebar  ui-widget-header  ui-corner-all  ui-helper-clearfix").bind("mousedown",
            function() {
                s.focus()
            }).prependTo(s),
    ...
    e.widget("ui.tabs", {
        ...
        _create: function() {
            ...
            if (r === null) {
                i && this.tabs.each(function(t, n) {
                    if (e(n).attr("aria-controls") === i) return r = t,
                    !1
                }),
            ...
            e.isArray(n.disabled) && (n.disabled = e.unique(n.disabled.concat(e.map(this.tabs.filter(".ui-state-disabled"),
            function(e) {
        ...
        refresh: function() {
            ...
            t.disabled = e.map(n.filter(".ui-state-disabled"),
            function(e) {
                return n.index(e)
            }),
            this._processTabs(),
    ...
    e.widget("ui.tooltip", {
        ...
        close: function(t) {
            ...
            r(i),
            s.stop(!0),
            this._hide(s, this.options.hide,
            function() {
            ...
            t && t.type === "mouseleave" && e.each(this.parents,
            function(t, r) {
        ...
        e.fn.extend({
            effect: function() {
                function a(n) {
                    ...
                    var r = e(this),
                    i = t.complete,
                    s = t.mode; (r.is(":hidden") ? s === "hide": s === "show") ? u() : o.call(r[0], t, u)
                }
